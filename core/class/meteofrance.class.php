...
class meteofrance extends eqLogic {
  ...
  public function getDetailsValues() {
    ...
    $this->checkAndUpdateCmd('Meteoday0picto', $return['result']['resumes']['0_resume']['picto']);
    ...
    $this->checkAndUpdateCmd('Meteoday1picto', $return['result']['resumes']['1_resume']['picto']);
    ...
    $this->checkAndUpdateCmd('Meteoday2picto', $return['result']['resumes']['2_resume']['picto']);
    ...
    $this->checkAndUpdateCmd('Meteomatin0picto', $return['result']['previsions']['0_matin']['picto']);
    ...
    $this->checkAndUpdateCmd('Meteomatin1picto', $return['result']['previsions']['1_matin']['picto']);
    ...
    $this->checkAndUpdateCmd('Meteomidi0picto', $return['result']['previsions']['0_midi']['picto']);
    ...
    $this->checkAndUpdateCmd('Meteomidi1picto', $return['result']['previsions']['1_midi']['picto']);
    ...
    $this->checkAndUpdateCmd('Meteosoir0picto', $return['result']['previsions']['0_soir']['picto']);
    ...
    $this->checkAndUpdateCmd('Meteosoir1picto', $return['result']['previsions']['1_soir']['picto']);
    ...
    $this->checkAndUpdateCmd('Meteonuit0picto', $return['result']['previsions']['0_nuit']['picto']);
    ...
    $this->checkAndUpdateCmd('Meteonuit1picto', $return['result']['previsions']['1_nuit']['picto']);
